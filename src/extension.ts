...
export function activate(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('tomcat.server.customizejvmoptions', (server: TomcatServer) => tomcatController.customizeJVMOptions(server)));
